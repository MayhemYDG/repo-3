...
require (
	github.com/influxdata/influxdb-observability/common v0.2.28-0.20220915142310-adbee7fb8146
	github.com/influxdata/influxdb-observability/otel2influx v0.2.28-0.20220915142310-adbee7fb8146
