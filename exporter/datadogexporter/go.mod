...
require (
	...
	github.com/DataDog/datadog-agent/pkg/otlp/model v0.43.2
	github.com/DataDog/datadog-agent/pkg/quantile v0.43.2
	github.com/DataDog/datadog-agent/pkg/trace v0.43.2
...
require (
	...
	github.com/DataDog/datadog-agent/pkg/obfuscate v0.43.2 // indirect
	github.com/DataDog/datadog-agent/pkg/remoteconfig/state v0.43.2 // indirect
	github.com/DataDog/datadog-agent/pkg/util/cgroups v0.43.2 // indirect
	github.com/DataDog/datadog-agent/pkg/util/log v0.43.2 // indirect
	github.com/DataDog/datadog-agent/pkg/util/pointer v0.43.2 // indirect
	github.com/DataDog/datadog-agent/pkg/util/scrubber v0.43.2 // indirect
